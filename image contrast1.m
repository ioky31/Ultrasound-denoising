...
noise = imread('kidney_cut_sigma0.03.bmp');
...
% SRAD
denoised1 = specklefilt(noise,DegreeOfSmoothing=0.01,NumIterations=40);
% SARBM3D
denoised2 = SARBM3D_v10(noise,100);
% NPD
denoised3 = NPD(noise);
% OBNLM
...
% no_log
denoised6 = imread("D:\swimir_result\no_log\sigma0.03\test_images\kidney_cut.bmp");
denoised6 = imresize(denoised6, [128,128]);
% log
denoised7 = imread("D:\swimir_result\log\sigma0.03\test_images\kidney_cut.bmp");
