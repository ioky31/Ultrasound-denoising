...
% SRAD
denoised1 = specklefilt(noise,DegreeOfSmoothing=0.029,NumIterations=90);
% SARBM3D
denoised2 = SARBM3D_v10(noise,9);
% NPD
denoised3 = NPD(noise);
% OBNLM
...
% FANS
denoised4 = FANS(noise,13);
% LF
% denoised = LF(noise,5, 5, 5);
% res = im - noise;
% var(res(:))
% WNNM
denoised5 = my_WNNM(noise,8.5);
% no_log
denoised6 = imread("D:\swimir_result\no_log\sigma0.5\test_images\kidney_cut.bmp");
denoised6 = imresize(denoised6, [128,128]);
% log
denoised7 = imread("D:\swimir_result\log\sigma0.5\test_images\kidney_cut.bmp");
